...
df = pandas.read_csv(args[0],sep='\t',converters={4:CustomParser},header=None)
...
#print(df)
#print(df_)
df_.to_csv(sys.stdout, columns=['pathogen_tax_id','collection_date','country','host','isolate'], index=False)
